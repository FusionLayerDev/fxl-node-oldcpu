...
var (
	...
	FusionLayerGenesisHash   = common.HexToHash("0xd6fb1976d24c856cee29f697c524cdb517be4d21b89885f2072778bf73e5d515")
)
...
var (
	...
	// FusionLayerConfig contains the chain parameters to run a node on the FusionLayer network.
	FusionLayerConfig = &ChainConfig{
		ChainID:                       big.NewInt(5070),
		HomesteadBlock:                big.NewInt(0),
		DAOForkBlock:                  nil,
...
var NetworkNames = map[string]string{
	...
	FusionLayerConfig.ChainID.String():   "fusionlayer",
}
...
type ChainConfig struct {
	...
	FusionLayerBlock *big.Int `json:"FusionLayerBlock,omitempty"` // FusionLayer switch time (nil = no fork, 0 = already on fusionlayer)
...
func (c *ChainConfig) Description() string {
	...
	case c.Ethash != nil:
		if c.TerminalTotalDifficulty == nil {
			banner += "Consensus: FusionHash (proof-of-work)\n"
...
// IsFusionLayer returns whether num is either equal to the FusionLayer fork time or greater.
func (c *ChainConfig) IsFusionLayer(num *big.Int) bool {
	return isBlockForked(c.FusionLayerBlock, num)
}
